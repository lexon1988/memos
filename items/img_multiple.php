...
<!-- ### Полный текст2 -->
    ...
    <div class="grid-item grid-item-multy ">
		...
		<!-- Полный текст -->
		  ...
		  <span class='glyphicon glyphicon-remove' style='float:right; margin-top:10px; margin-left:10px;'' id='text_full_close3'></span>
			<hr>
	  ...
	  <!-- ### Полный текст -->
			...
			<?php
				...
				list($width, $height, $type, $attr) = getimagesize("rezimg/2.jpg");
				$perc2=275/($width*0.01)*0.01;
				$crop2= 32*$perc2;				

				list($width, $height, $type, $attr) = getimagesize("rezimg/3.jpg");
				$perc3=275/($width*0.01)*0.01;
				$crop3= 32*$perc3;
				
				list($width, $height, $type, $attr) = getimagesize("rezimg/4.jpg");
				$perc4=275/($width*0.01)*0.01;
				$crop4= 32*$perc4;

				list($width, $height, $type, $attr) = getimagesize("rezimg/5.jpg");
				...
				list($width, $height, $type, $attr) = getimagesize("rezimg/7.jpg");
				$perc7=275/($width*0.01)*0.01;
				$crop7= 32*$perc7;		

				list($width, $height, $type, $attr) = getimagesize("rezimg/8.jpg");
				$perc8=275/($width*0.01)*0.01;
				$crop8= 32*$perc8;

				list($width, $height, $type, $attr) = getimagesize("rezimg/9.jpg");
				$perc9=275/($width*0.01)*0.01;
				$crop9= 32*$perc9;						

				list($width, $height, $type, $attr) = getimagesize("rezimg/10.jpg");
