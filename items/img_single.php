...
<div class='modal_text' id='modal_text2' style=''>
    ...
    <div class="modal_text_topbar">
        ...
        <div style="width: 85%; display: inline-block; height: 50px;">
            <img  src="https://cs7053.vk.me/c637925/v637925048/969b/_vOhGgDOl0k.jpg" style="border-radius: 30px; display: inline-block;"><div style="display: inline-block; ">- название сообщества очень длинное в две строчки</div></div>


        <span class='glyphicon glyphicon-remove ' style='color:white; font-size:30px; color:white; padding:10px; float: right' id='modal_text_close2'></span>
    </div>
	...
	<div class="grid-item">
	  ...
	  <!-- ### Полный текст -->
       ...
       <div class="soc_block">
		...
		<div style="overflow:hidden;">
			<a href='rezimg/6.jpg' class='fancybox-thumbs' data-fancybox-group='button'><img class='img_main' src='rezimg/6.jpg' style="margin:0px 0px -<?php echo $crop; ?>px 0px;"></a>
		</div>
		
		
		<div class='text'>
			<p>А тут мы напишем текста на 140 символов, такой же как у твиттера, который стимулирует креотивность и прочее. Осталось ещё примерно 30 символов, но нужно... <a href='###'  id='text_full_show2' > +785</a></p>
		...
		<table width=100%>
			<tr>
				...
				<td  width='33%' style='text-align:center;'>
					<div class='midle_butt' id='text_full_show_modal2'><span class='glyphicon glyphicon-unchecked' style='margin-left:3.5px;'></span></div>
